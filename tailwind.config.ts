    ...
    extend: {
      ...
      colors: {
        ...
        neon: {
          ...
          petrol: "hsl(var(--neon-petrol))",
          deep: "hsl(var(--neon-deep))",
        },
        surface: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(258 90% 66% / 0.4)" },
          "50%": { boxShadow: "0 0 60px hsl(258 90% 66% / 0.7), 0 0 100px hsl(195 100% 50% / 0.2)" },
        },
        shimmer: {
